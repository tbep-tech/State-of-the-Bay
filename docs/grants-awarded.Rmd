...
```{r, out.width = '100%'}
grntsum_plo(tberfdat, maxyr = maxyr, family = fml, width = NULL, height = 400)
```

### Bay Mini Grants

```{r, out.width = '100%'}
grntsum_plo(bmgdat, maxyr = maxyr, family = fml, width = NULL, height = 400)
```

### License Plate Sales

```{r, out.width = '100%'}
grntsum_plo(comdat, maxyr = maxyr, family = fml, width = NULL, height = 400)
```
