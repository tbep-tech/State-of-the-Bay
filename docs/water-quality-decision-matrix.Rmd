...
<!-- This map shows the outcomes for each bay segment in `r maxyr`.  The color of the bay segment indicates the management action category, with the points showing chlorophyll (left) and light attenuation (right) for each monitoring used to estimate the categories. -->
