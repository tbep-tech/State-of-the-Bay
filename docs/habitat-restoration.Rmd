...
maxyr <- 2022
# https://docs.google.com/spreadsheets/d/1z9R66bdRiM77IdXNGE_dAoiw98dMeyNNRX8qz0-s4pU/edit#gid=499627586
rstdat <- read_sheet('1z9R66bdRiM77IdXNGE_dAoiw98dMeyNNRX8qz0-s4pU')
totacr <- rstdat %>% 
  filter(`GeneralActivity` == 'Restoration') %>% 
  pull(Acres) %>% 
  sum(na.rm = T) %>% 
  round(0) %>% 
...
* [Habitat restoration table](https://drive.google.com/file/d/1zVx18P6lrPuVR6ANMAetBRXwxCGeCN9b/view?usp=sharing){target="_parent"}
