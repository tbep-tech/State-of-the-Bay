...
```{r}
p <- comssum_plo(comdat, category = 'Social Media', metric = 'users', family = fml, width = 700, height = 600)
div(p, align = 'center')
```
...
```{r}
p <- comssum_plo(comdat, category = 'Social Media', metric = 'engagement', family = fml, width = 700, height = 600)
div(p, align = 'center')
```
