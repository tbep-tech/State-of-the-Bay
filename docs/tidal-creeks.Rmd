...
The current assessment period (`r maxyr`) indicates that `r sumdat['Prioritize']` creeks had a <span style="color:#FF7F50; letter-spacing: 2px">__Prioritize__</span> score, `r sumdat['Investigate']` had an <span style="color:#FFA500; letter-spacing: 2px">__Investigate__</span> score, `r sumdat['Caution']` had a <span style="color:#F9FF33; letter-spacing: 2px">__Caution__</span> score, and `r sumdat['Monitor']` had a <span style="color:#33FF3B; letter-spacing: 2px">__Monitor__</span> score.  The remaining `r sumdat['No Data']` creeks in the Tampa Bay watershed had insufficient data for the current assessment period to assign a category.  The plot below shows a breakdown of scores for all creeks, with the final score in the right column and the number of survey years in each category used to calculate the final score in the remaining columns. 
