...
```{r}
ldtot_plo(totanndat, yval = 'tnhy', levs = c('Old Tampa Bay', 'Hillsborough Bay', 'Middle Tampa Bay', 'Lower Tampa Bay'), 
          addlns = T, width = 1000, height = 650, family = fml)
```
...
```{r, out.width = '100%'}
ldrat_plo(totanndat, popdat, width = 1000, height = 400, family = fml)
```

See additional visualization tools for nutrient loading data here: https://tbep-tech.github.io/load-estimates/.
