...
```{r}
lngtrmtab_fun(subtacres, 'Category', typ = 'subtidal', yrsel = '1988', topyr = '2020', estout = F)
```
...
```{r}
lngtrmtab_fun(acres, 'Category', typ = 'supratidal', yrsel = '1990', topyr = '2020', estout = F)
```
